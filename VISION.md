...
**R12. The content cliff arrives at five levels.**
...
### 4. A 2.5D board, on the same canvas, with no dependencies
...
### 6. The additions already in flight, placed
...
### 7. The full roster, and a level where each one is wrong
...
### Now: make it a game (the captain's note)
